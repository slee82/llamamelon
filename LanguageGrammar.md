...
Note that this is not where we keep track of the latest grammar; it's stored inside the repository under docs. This page will be updated periodically.
...
function_definition : "function" identifier "(" parameter_list ")" "returns" type ":" body_statement_list "end"
                    | "function" identifier "(" parameter_list ")" "returns" type ":" "end"
                    ;
...
iteration_statement : "do:" body_statement_list "end"
                    ...
                    | "foreach" identifier "in" expression ":" body_statement_list "end"
                    ;
